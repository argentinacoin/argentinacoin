...
// Copyright (c) 2014-2014 Argentina Coin Developers 
...
uint256 hashGenesisBlock("0x0cd75b889a29d54555db488e7eead5e97f2db4ad67ec881ff8dce65267a4bb55");
...
const string strMessageMagic = "ArgentinaCoin Signed Message:\n";
...
{
    int64 nSubsidy = 1816 * 2 * COIN;

	if (nHeight > 60) //first 60 blocks slowed
		nSubsidy =  18 * COIN;

	if (nHeight == 1)
		nSubsidy = 420000000 * COIN;

    	nSubsidy >>= (nHeight / 31000); // Reward halves every 90 days

    return nSubsidy + nFees;
}


static const int64 nTargetTimespan = 5040; //every 84 minutes
static const int64 nTargetSpacing = 252; //every 4.2 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal argentinacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ArgentinaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa468703b2f5da5905938f7f1af2a64c0ff66fc7e7ef0c5f0b85d5b3911670273");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "IBTimes 18/Mar/2014 Official inflation in Argentina during February, 3.4% and 7.1% in two months";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395447936; 
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 980778;

        if (fTestNet)
        {
            block.nTime    = 1395195456;
            block.nNonce   = 1602213;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe9c7a9e5df8a727f80caa8acf651f4444e03bea343f5839db45b762cf1a7ca3f"));
